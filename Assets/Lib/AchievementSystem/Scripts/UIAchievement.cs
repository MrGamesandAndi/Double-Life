...
public class UIAchievement : MonoBehaviour
{
    ...
    public void Set (AchievementInfromation Information, AchievementState State)
    {
        if(Information.Spoiler && !State.Achieved)
        {
            ...
            SpoilerText.text = AchievementManager.instance.SpoilerAchievementMessage.Value;
        }
        else
        {
            Title.text = Information.DisplayName.Value;
            Description.text = Information.Description.Value;
