...
namespace LevelingSystem
{
    public abstract class BaseXPTranslation : ScriptableObject
    {
        ...
        public int XPRequieredForNextLevel => GetXPRequieredForNextLevel();
        ...
        protected abstract int GetXPRequieredForNextLevel();

        public abstract int GetTotalXPForNextLevel();
    }
}
